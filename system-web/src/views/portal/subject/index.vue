<template>
    ...
    <a-row align="center">
      <a-col :span="20">
        <a-form :model="form" layout="inline">
          <a-row class="w-full">
            <a-col :span="8">
              <a-form-item field="name" label="科目名称">
  ...
  <AddSubjectDrawer ref="AddSubjectDrawerRef" />
</template>

<script lang="ts" setup>
import AddSubjectDrawer from './components/AddSubjectDrawer.vue'
...
/** @description 新增部门 */
const handleAdd = () => {
  AddSubjectDrawerRef.value?.open()
}
...
const handleEdit = (record: any) => {
  AddSubjectDrawerRef.value?.onUpdate(record.id)
}
...
const AddSubjectDrawerRef = ref<InstanceType<typeof AddSubjectDrawer>>()
</script>
