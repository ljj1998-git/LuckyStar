...
export class MenuController {
  ...
  addSysMenu(@Body() createMenuReq: CreateMenuReq, @Req() req: CustomRequest) {
  ...
  deleteSysMenu(@Query() params: QueryMenuInfoReq, @Req() req: CustomRequest) {
  ...
  updateSysMenu(
    @Body() createMenuReq: UpdateMenuReq,
